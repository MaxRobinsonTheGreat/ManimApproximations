...
class RecurrentNN(nn.Module):
	def __init__(self, in_size=1, out_size=1, hidden_size=5, hidden_layers=2, iterations=5, activation=nn.GELU):
		super().__init__()
		self.iterations = iterations
		self.in_layer = nn.Linear(in_size, hidden_size)
		# self.inner_model = SimpleNN(in_size=hidden_size, out_size=hidden_size, hidden_size=hidden_size, hidden_layers=hidden_layers, activation=activation)
		# self.inner_model = SkipConn(in_size=hidden_size, out_size=hidden_size, hidden_size=hidden_size, hidden_layers=hidden_layers, activation=activation)
		self.inner_model = Fourier(in_size=hidden_size, out_size=hidden_size, fourier_order=4, hidden_size=hidden_size, hidden_layers=hidden_layers)
